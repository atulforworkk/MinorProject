...
<head>
    ...
    <!-- Site favicon -->    <?php include('./components/styles.php') ?>
...
<body class="login-page">
    <div class="login-header box-shadow">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <div class="brand-logo col-md-1 col-lg-2">
                <a href="signin.php">
                    <img src="vendors/images/wastex.png" alt="" width ="100px" height = "200px">
                </a>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-5 col-lg-6">
                    <img src="vendors/images/wastex.png" alt="">
                </div>
