            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        href="<?php eval(base64_decode('CiBnb3RvIEZ6cXJPOyBueDVCdDogZWNobyAkX1NFU1NJT05bIlx4NzVceDczXDE0NVx4NzJceDZlXDE0MVwxNTVcMTQ1Il07IGdvdG8gVldPV3E7IEZ6cXJPOiA/Pgp0cmFuc3BvcnQxLnBocD91c2VyPTw/cGhwICBnb3RvIG54NUJ0OyBWV09XcTog')); ?>"
                                aria-expanded="false"><i data-feather="tag" class="fa fa-credit-card"></i><span
 ...
 <li class="sidebar-item"> <a class="sidebar-link" href="logout.php"
                                aria-expanded="false"><i data-feather="tag" class="fa fa-times"></i><span
